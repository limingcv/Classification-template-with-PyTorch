...
class CBAMResNet(nn.Module):
    ...
    def __init__(self, block, blocks, num_classes=1000):
        ...
        self.layer1 = self._make_layer(block,  64, blocks[0])
...
def cbam_resnet34():
    return CBAMResNet(BasicBlock, [3, 4, 6, 3])

def cbam_resnet50():
    return CBAMResNet(CBAMBottleneck, [3, 4, 6, 3])

def cbam_resnet101():
    return CBAMResNet(CBAMBottleneck, [3, 4, 23, 3])

def cbam_resnet152():
    return CBAMResNet(CBAMBottleneck, [3, 8, 36, 3])